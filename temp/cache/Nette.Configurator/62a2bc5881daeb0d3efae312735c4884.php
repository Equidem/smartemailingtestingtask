<?php
// source: /opt/lampp/htdocs/SmartEmailing/app/config/config.neon 
// source: /opt/lampp/htdocs/SmartEmailing/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/opt/lampp/htdocs/SmartEmailing/app',
			'wwwDir' => '/opt/lampp/htdocs/SmartEmailing/www',
			'debugMode' => FALSE,
			'productionMode' => TRUE,
			...
			'tempDir' => '/opt/lampp/htdocs/SmartEmailing/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/opt/lampp/htdocs/SmartEmailing/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/opt/lampp/htdocs/SmartEmailing/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/opt/lampp/htdocs/SmartEmailing/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/opt/lampp/htdocs/SmartEmailing/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/opt/lampp/htdocs/SmartEmailing/app/../temp/cache', $this->getService('nette.cacheJournal'));
