<?php
// source: /opt/lampp/htdocs/SmartEmailing/app/templates/@layout.latte

// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('8800097208', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbdce60d87df_head')) { function _lbdce60d87df_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lbd20c4e80a3_scripts')) { function _lbd20c4e80a3_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
